...
export const ESPN_RESULT_ALIASES = {
  ...
  'FC Red Bull Salzburg': 'Red Bull Salzburg',
  'FC Copenhagen':        'Copenhagen',
  // WorldCup / Euro — ESPN country name differences
  'United States':        'USA',
  "Côte d'Ivoire":        'Ivory Coast',
  'Cote d\'Ivoire':       'Ivory Coast',
  'Korea Republic':       'South Korea',
  'IR Iran':              'Iran',
  // NCAAF — ESPN uses "School Mascot" displayName; TEAM_POOLS uses school name only
  'Alabama Crimson Tide':      'Alabama',
  'Arizona Wildcats':          'Arizona',
  ...
  'Washington Huskies':        'Washington',
  'Wisconsin Badgers':         'Wisconsin',
  // NCAAMB — same "School Mascot" format (many overlap with NCAAF above)
  'Creighton Bluejays':        'Creighton',
  'Gonzaga Bulldogs':          'Gonzaga',
  'Louisville Cardinals':      'Louisville',
  'Marquette Golden Eagles':   'Marquette',
  ...
  'Texas Tech Red Raiders':    'Texas Tech',
  'Villanova Wildcats':        'Villanova',
  // Golf — diacritics that ESPN may or may not preserve
  'Ludvig Aberg':              'Ludvig Åberg',
  // Tennis ATP — name format differences from ESPN
  'Felix Auger Aliassime':     'Felix Auger-Aliassime',
  'Alex De Minaur':            'Alex de Minaur',
  // Tennis WTA
  'Bia Haddad Maia':           'Beatriz Haddad Maia',
